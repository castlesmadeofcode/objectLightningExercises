...
const paulMcCartney = beatles.members[1].name;
const formedDate = beatles.history.formed;
const disbandedDate = beatles.history.disbanded;
const birthDate = beatles.members[1].birth;
const magicalMysteryTour = beatles.albums[3];

console.log (`${paulMcCartney} was in the Beatles from ${formedDate} to 
${disbandedDate}. He was born in ${birthDate}. He contributed heavily to the
${magicalMysteryTour} Album.`)
